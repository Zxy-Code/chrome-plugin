$(function(){
    ...
    var $picker = $('#picker');
    var $urlBox = $('#url-box');
    var baseUrl = encodeURIComponent(location.href), realUrl, qrCodeColor = defaultConfig.QRcodeColor, titleId = defaultConfig.titleId, timerId;
    ...
    var getUrl = function (val) {
        if (val === '1') {
            ...
            realUrl = 'baidumap://map/component?comName=carowner&target=open_web_page&popRoot=no&param=%7B%22url%22%3A%22' + baseUrl + '%22%2C%22showShare%22%3A0%7D';
        } else if (val === '4') {
    ...
    (function(){
        ...
        $select.find('option[value=' + qrCodeColor + ']').attr('selected', true);
        $select.change();
